...
template <typename rst, typename dc, typename led, typename select = ss,
...
public:
  ...
  static void activate() {
    ...
    spi_master::activate();
    spi_master::setPrescaler(spi::_clk_4);
  ...
  /* ------------------------------------------------------------------------ */
  static void setBacklight(uint8_t power) { led::analogWrite(power); }
